...
val lightGratiaColors = GratiaColors(
    ...
    accent = Color(0xFFFA243C),     // the industry standard Red
    ...
    progressActive = Color(0xFFFA243C), // Wait, the industry standard progress bar is usually white or grey, but red when active
