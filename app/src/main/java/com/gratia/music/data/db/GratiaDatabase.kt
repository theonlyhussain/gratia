...
val MIGRATION_9_10 = object : Migration(9, 10) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE songs ADD COLUMN providerTrackId TEXT DEFAULT NULL")
        db.execSQL("ALTER TABLE songs ADD COLUMN providerArtistId TEXT DEFAULT NULL")
        db.execSQL("ALTER TABLE songs ADD COLUMN providerAlbumId TEXT DEFAULT NULL")
        db.execSQL("ALTER TABLE songs ADD COLUMN artworkUrl TEXT DEFAULT NULL")
    }
}
...
val MIGRATION_10_11 = object : Migration(10, 11) {
    override fun migrate(db: SupportSQLiteDatabase) {
        ...
        db.execSQL("ALTER TABLE songs ADD COLUMN downloadPath TEXT DEFAULT NULL")
    }
}
